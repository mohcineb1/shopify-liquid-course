...
- [x] 18.1 Section blocks — local, simple, limited to their parent
- [x] 18.2 Theme blocks — files in `blocks/`, reusable across every section
- [x] 18.3 App blocks — merchant-installed, third-party
- [x] 18.4 The comparison table: reusability, nesting, schema rules, limits
- [x] 18.5 When each kind is the right answer
...
3. `../../../solutions/part-03-theme-architecture/ch-18-blocks-the-three-kinds/solution.md` — the worked answer.
